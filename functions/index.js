...
app.get('/', (req, res) => {
    ...
    <html lang=en>
        <head>
          ...
          <link href=/js/chunk-07652a3e.61e72ead.js rel=prefetch>
          ...
          <link href=/js/app.d3db2fea.js rel=preload as=script>
        ...
        <body>
         ...
         <script src=/js/app.d3db2fea.js></script>
      </body>
      ...
      <script src=/__/firebase/7.15.4/firebase-app.js></script><script src=/__/firebase/7.15.4/firebase-analytics.js></script>
